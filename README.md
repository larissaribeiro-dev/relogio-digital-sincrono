...
├── 📁 Q1-Portas-Logicas/        ← LTSpice com lógica discreta CMOS
├── 📁 Q2-Contadores-Comerciais/ ← LTSpice com CIs comerciais CMOS
├── 📁 Q3-Verilog/               ← Código HDL + Testbench + síntese FPGA
├── 📁 imagens/
│   ├── circuito-q1.png
│   ├── circuito-q2.png
